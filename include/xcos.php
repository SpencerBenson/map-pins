...
class xcos {
	...
	static public function TrFormInput($name,$label,$value='',$args=array()) {
	...
	static public function TrFormTextarea($name,$label,$value='',$args=array()) {
		$fullid="mappin_map_$name";
		$fullname="mappin_map[$name]";
		echo '
			<tr valign="top">
	...
	static public function TrFormSelect($name,$label,$value='',$opts=array(),$args=array()) {
		$fullid="mappin_map_$name";
		$fullname="mappin_map[$name]";
		echo '
			<tr valign="top">
